...
public class DiscoverFragment extends BaseFragment implements DiscoverConstract.View<DiscoverPresenter>{
	...
	public class ImageHolder implements CBPageAdapter.Holder<Index.FocusPicBean.ItemsBean> {
		...
		if (focusPicBean != null && focusPicBean.getItems().size() != 0) {
			...
			convenientBanner.setPages( new CBViewHolderCreator<ImageHolder>() {
				...
				public ImageHolder createHolder() {
					...
					.setPageTransformer(ConvenientBanner.Transformer.ZoomOutTranformer);
		}
