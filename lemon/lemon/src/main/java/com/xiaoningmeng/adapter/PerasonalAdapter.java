...
public class PerasonalAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.favTv.setText(albumInfo.getFavnum() == 0 ? "收藏" : Integer.toString(albumInfo.getFavnum()));
        holder.favTv.setSelected(albumInfo.getFav() == 1);
        holder.titleTv.setText(albumInfo.getTitle());
        holder.commentTv.setText(albumInfo.getCommentnum() == 0 ? "评论" : Integer.toString(albumInfo.getCommentnum()));
