...
public class LoginActivity extends BaseActivity implements OnClickListener {
        ...
        case 2:
          if (data != null) {
            ...
            if (!accessToken.equals("") && !openId.equals("") && !nickName.equals("")) {
              ...
              DebugUtils.d("LoginQQ will Run : accessToken = "
                      + accessToken
                      + ", openId = "
                      + openId
                      + ", nickName = "
  ...
  private void loginQQ(final String accessToken, final String openId, final String nickName) {
    ...
    LHttpRequest.QQLoginRequest QQLoginRequest =
            LHttpRequest.mRetrofit.create(LHttpRequest.QQLoginRequest.class);
      ...
      public void onResponse(Call<JsonResponse<UserInfo>> call,
        ...
        if (response.isSuccessful()) {
          ...
          if (response.body().isSuccessful()) {
            ...
            UserAuth.getInstance().login(mContext, response.body().getData());
  ...
  public void onEventMainThread(LoginEvent event) {
    ...
    if (uc_callback != null && !uc_callback.equals("")) {
      ...
      LHttpRequest.UCSyncLoginRequest ucSyncLoginRequest =
              LHttpRequest.mRetrofit.create(LHttpRequest.UCSyncLoginRequest.class);
      ...
      call.enqueue(new Callback<JsonForumResponse<ForumLoginVar>>() {
        ...
        @Override
        public void onResponse(Call<JsonForumResponse<ForumLoginVar>> call,
                               Response<JsonForumResponse<ForumLoginVar>> response) {
          try {
