...
public class AccountActivity extends BasePohotoActivity implements
    ...
    public void requestUserInfo() {
        ...
        LHttpRequest.GetUserInfoRequest getUserInfoRequest = mRetrofit.create(LHttpRequest.GetUserInfoRequest.class);
        Call<JsonResponse<UserInfo>> call = getUserInfoRequest.getResult();
    ...
    private void uploadAvatartime() {
        ...
        LHttpRequest.SetUserInfoRequest setUserInfoRequest = mRetrofit.create(LHttpRequest.SetUserInfoRequest.class);
        Call<JsonResponse<String>> call = setUserInfoRequest.getResult(null, null, null, null, null, null, null, null, avatartime + "");
        call.enqueue(new Callback<JsonResponse<String>>() {
