...
public class NewThreadActivity extends BaseActivity
        implements View.OnClickListener, KeyboardFragment.OnFragmentInteractionListener, AddedImageFragment.OnAddedImgListener {
    ...
    private String SAVED_IMAGE_DIR_PATH = Environment.getExternalStorageDirectory() + "/DCIM/Camera";// 图片的存储目录
    ...
    private void setAddedImageFragment() {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.fl_added_image, addedImageFragment, "addedImageFragment").commit();
    ...
    private void commitThreadMessage(ArrayList<String> aids) {
        ...
        if (fid != 0 && formHash != null && !formHash.equals("")) {
            ...
            String url = ConstantURL.FORUM_NEW_THREAD;
            ...
            LHttpRequest.ForumNewThreadRequest forumNewThreadRequest = mRetrofit.create(LHttpRequest.ForumNewThreadRequest.class);
            Call<JsonForumResponse<JsonObject>> call = forumNewThreadRequest.getResult(url, formHash, fid, subject, message);
            call.enqueue(new Callback<JsonForumResponse<JsonObject>>() {
                ...
                public void onResponse(Call<JsonForumResponse<JsonObject>> call, Response<JsonForumResponse<JsonObject>> response) {
                    ...
                    try {
                        ...
                        JsonForumResponse.MessageBean messageObject = response.body().getMessage();
                        if (null != messageObject) {

                            String messageVal = messageObject.getMessageval();
                            String messageStr = messageObject.getMessagestr();
