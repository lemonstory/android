...
public class XListView extends ListView implements OnScrollListener {
	...
	private int footViewMarginBottom = 0;
	private boolean isNoMore;

	// feature.
	// 高级的滚动，使头部上滑跟随，下滑刷新
	private boolean seniorScroll = false;
	...
	public XListView(Context context, AttributeSet attrs, int defStyle) {
		...
		seniorScroll = a.getBoolean(R.styleable.xListView_seniorScroll, false);
		footViewMarginBottom = a.getDimensionPixelOffset(
				R.styleable.xListView_footViewMarginBootom, 0);
		a.recycle();
		initWithContext(context);
	}
	...
	private void initWithContext(Context context) {
		...
		// init footer view
		mFooterView = new XListViewFooter(context, footViewMarginBottom);
	...
	public void addSeniorHeaderView(View view) {

		if (seniorScroll) {
			View topView = new View(getContext());
			topView.setLayoutParams(new AbsListView.LayoutParams(
