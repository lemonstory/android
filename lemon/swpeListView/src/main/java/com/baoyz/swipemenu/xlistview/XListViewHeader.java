...
public class XListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		mUniformRotateAnimDrawable = (AnimationDrawable)getResources()
				.getDrawable(R.drawable.refresh_anim_list);
	}
	...
	public void setState(int state) {
		...
		if (state == STATE_REFRESHING) { // 显示进度
			...
			mProgressBar.setImageDrawable(mUniformRotateAnimDrawable);
