...
public class XListViewFooter extends LinearLayout {
	...
	public XListViewFooter(Context context, int initMarginBottom) {
		super(context);
		this.initMarginBottom = initMarginBottom;
		initView(context);
	}
	...
	public void setState(int state) {
		...
		if (state == STATE_READY) {
			...
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(isNoMore ? R.string.xlistview_footer_hint_no_more
	...
	public void setBottomMargin(int height) {
		...
		LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) mContentView
				.getLayoutParams();
		lp.bottomMargin = height + initMarginBottom;
	...
	public void hide() {
		LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) mContentView
				.getLayoutParams();
		lp.height = 0;
		lp.bottomMargin = initMarginBottom;
		mContentView.setLayoutParams(lp);
	}
