...
public class DialogPlus {
    ...
    private DialogPlus(Builder builder) {
        ...
        shieldActionUp = builder.ShieldActionUp;
        ...
        rootView.setBackgroundColor( builder.context.getResources().getColor(builder.isTransparentBg ? android.R.color.transparent : R.color.black_overlay));
    ...
    public static class Builder {
        ...
        public Builder setIsTransparentBg(boolean isTransparent){
        ...
        public Builder setShieldActionUp(boolean isShield){

        	ShieldActionUp = isShield ? 0:1;
        	return this;
        }
    ...
    public void setExcessCanDismiss(boolean isDismiss){
